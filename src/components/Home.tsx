...
const Home = () => {
  ...
  useEffect(() => {
    db.collection('messages').orderBy('created', 'asc').onSnapshot(snapshot => {
  ...
  return (
    <div className="Home">
      <img src="https://facebookbrand.com/wp-content/uploads/2018/09/Header-e1538151782912.png?w=99&amp;h=99" alt="messenger logo" />
      ...
      <Grid
        ...
        justify="center"
      >
        <Flipper flipKey={ messages.join() } spring="gentle" className="home__flipper">
        ...
        <form className="home__form">
            <FormControl className="home__formControl">
              ...
              />
              <IconButton className="home__iconButton" color="primary" disabled={ !newMessage } onClick={ sendMessage } type="submit">
